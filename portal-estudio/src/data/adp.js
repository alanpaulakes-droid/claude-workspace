...
export const analisisDescriptivoProcesos = {
  ...
  temas: [
    ...
    // ===================== SESIÓN 10 =====================
    {
      id: 's10-analisis-descriptivo',
      titulo: 'Análisis descriptivo, indicadores e inteligencia de negocios',
      resumen: 'Objetivo del análisis descriptivo, formulación de indicadores, toma de decisiones e inteligencia de negocios (BI).',
      contenido: [
        { tipo: 'p', texto: 'Esta sesión define el análisis descriptivo de procesos, cómo formular y validar indicadores, cómo se toman decisiones en las organizaciones y qué es la inteligencia de negocios (BI).' },

        { tipo: 'h', texto: '¿Qué es el análisis descriptivo de procesos?' },
        { tipo: 'p', texto: 'Es una metodología para recolectar y ordenar la información —mediante gráficos y otras representaciones visuales— para extraer las características más representativas de un grupo de datos y describir tendencias y patrones en grandes volúmenes. Se aplica en finanzas, redes sociales, operaciones y muchas otras áreas.' },
        { tipo: 'img', src: 'img/adp/s10/fig01-ejemplos-descriptivo.png', alt: 'Ejemplos de análisis descriptivos en diferentes áreas', pie: 'Figura 1. Ejemplos de análisis descriptivos en distintas áreas.' },

        { tipo: 'h', texto: 'Análisis de indicadores' },
        { tipo: 'p', texto: 'Formular buenos indicadores sigue una guía de ocho pasos:' },
        { tipo: 'ol', items: [
          'Establecer las directrices del direccionamiento estratégico (misión, visión, objetivos, mapa de procesos) como referente.',
          'Determinar si todas las áreas realmente requieren medición.',
          'Establecer el nombre y la fórmula del indicador (objeto a cuantificar, condición deseada y elementos descriptivos).',
          'Especificar sus atributos (proceso, objetivo, fórmula, variables, unidad de medida, metas).',
          'Aplicar criterios técnicos para validarlo (vinculado a la misión, datos válidos y confiables, útil para los interesados).',
          'Establecer claramente las metas (desempeño medible y fecha/frecuencia).',
          'Evaluar el indicador durante un período de prueba.',
          'Socializar los indicadores y sus resultados.',
        ] },
        { tipo: 'img', src: 'img/adp/s10/fig02-guia-indicadores.png', alt: 'Guía para la formulación y análisis de indicadores', pie: 'Figura 2. Guía de ocho pasos para la formulación y análisis de indicadores.' },
        { tipo: 'nota', texto: 'Un buen indicador es claro, preciso y autoexplicativo: cualquier persona debería entender qué mide con solo leerlo.' },

        { tipo: 'h', texto: 'Toma de decisiones en las organizaciones' },
        { tipo: 'p', texto: 'El éxito o fracaso de una organización depende de sus decisiones. Se pasó del modelo clásico (racionalidad ilimitada, información completa, certeza total) a un enfoque conductual o naturalista que reconoce la racionalidad limitada (Simon): el decisor opera con limitaciones cognitivas.' },
        { tipo: 'p', texto: 'La teoría del proceso dual distingue dos formas de procesar: el pensamiento intuitivo (automático, rápido, autónomo) y el reflexivo (lento, consciente, analítico, basado en reglas). Existen distintos estilos de decisión (racional, intuitivo, dependiente, evitante, espontáneo) y modelos de personalidad como el Big Five (extraversión, amabilidad, conciencia, neuroticismo y apertura).' },

        { tipo: 'h', texto: 'Inteligencia de negocios (BI)' },
        { tipo: 'p', texto: 'La inteligencia de negocios (Business Intelligence) es la combinación de tecnología, herramientas y procesos que transforma los datos en información, la información en conocimiento y el conocimiento en una estrategia empresarial.' },
        { tipo: 'p', texto: 'Problemas que resuelve: tener datos pero no información, la fragmentación (datos en sistemas distintos), la manipulación manual (duplicidad, errores) y la falta de agilidad. Sus beneficios: manejar el crecimiento, controlar costos, conocer a los clientes y construir indicadores de gestión.' },
        { tipo: 'p', texto: 'Componentes de la arquitectura BI: fuentes de datos (ERP, CRM, legacy, web, externas), almacenamiento (integrado con ETL: extraer, transformar y cargar), analítica empresarial (modelos de análisis), gestión del rendimiento (BPM/CPM) e interfaces de usuario (dashboards y herramientas de visualización).' },
        { tipo: 'img', src: 'img/adp/s10/fig03-arquitectura-bi.png', alt: 'Arquitectura de un sistema de inteligencia de negocios', pie: 'Figura 3. Arquitectura de un sistema de inteligencia de negocios (BI): de las fuentes al data warehouse y las aplicaciones.' },
        { tipo: 'p', texto: 'Los dashboards (cuadros de mando) presentan de forma dinámica los aspectos clave del negocio para monitorear metas y apoyar la decisión.' },
        { tipo: 'img', src: 'img/adp/s10/fig04-dashboard.png', alt: 'Ejemplo de dashboard de inteligencia de negocios', pie: 'Figura 4. Ejemplo de dashboard: indicadores de negocio presentados de forma visual y dinámica.' },
      ],
      quiz: [
        {
          id: 'q1',
          pregunta: 'El análisis descriptivo de procesos busca principalmente…',
          opciones: [
            'Predecir el futuro con certeza',
            'Describir tendencias y patrones de un grupo de datos mediante representaciones visuales',
            'Programar en Python',
            'Contratar personal',
          ],
          correcta: 1,
          explicacion: 'Es una metodología para ordenar datos y extraer sus características, tendencias y patrones.',
        },
        {
          id: 'q2',
          pregunta: 'Según la guía, ¿qué debe hacerse ANTES de crear los indicadores?',
          opciones: [
            'Socializar los resultados',
            'Establecer las directrices del direccionamiento estratégico',
            'Evaluar el indicador',
            'Especificar la fórmula',
          ],
          correcta: 1,
          explicacion: 'El primer paso es establecer las directrices estratégicas (misión, visión, objetivos) como referente.',
        },
        {
          id: 'q3',
          pregunta: 'La "racionalidad limitada" (Simon) reconoce que el decisor…',
          opciones: [
            'Tiene información completa y certeza total',
            'Opera con limitaciones cognitivas y de información',
            'Nunca se equivoca',
            'Decide solo al azar',
          ],
          correcta: 1,
          explicacion: 'El enfoque conductual reconoce que el tomador de decisiones opera con limitaciones cognitivas (racionalidad limitada).',
        },
        {
          id: 'q4',
          pregunta: 'En la teoría del proceso dual, el pensamiento intuitivo es…',
          opciones: [
            'Lento, consciente y analítico',
            'Automático, rápido y autónomo',
            'Basado solo en reglas escritas',
            'Igual al reflexivo',
          ],
          correcta: 1,
          explicacion: 'El intuitivo es automático y rápido; el reflexivo es lento, consciente y analítico.',
        },
        {
          id: 'q5',
          pregunta: '¿Qué es la inteligencia de negocios (BI)?',
          opciones: [
            'Un tipo de compuerta BPMN',
            'Transformar datos en información, en conocimiento y en estrategia empresarial',
            'Un lenguaje de programación',
            'Una técnica de entrevista',
          ],
          correcta: 1,
          explicacion: 'BI combina tecnología, herramientas y procesos para convertir datos en información, conocimiento y estrategia.',
        },
        {
          id: 'q6',
          pregunta: 'En la arquitectura de BI, ¿qué hace el proceso ETL?',
          opciones: [
            'Presenta los dashboards',
            'Extrae, transforma y carga los datos hacia el almacenamiento',
            'Define la misión',
            'Entrevista a los usuarios',
          ],
          correcta: 1,
          explicacion: 'ETL integra los datos de las fuentes (extraer, transformar y cargar) antes de su análisis.',
        },
      ],
    },
  ],
  flashcards: [
    ...
    { id: 's10f1', frente: 'Análisis descriptivo', reverso: 'Metodología para ordenar datos y describir sus tendencias y patrones con visualizaciones.', tema: 's10-analisis-descriptivo' },
    { id: 's10f2', frente: 'Buen indicador', reverso: 'Claro, preciso y autoexplicativo: se entiende qué mide con solo leerlo.', tema: 's10-analisis-descriptivo' },
    { id: 's10f3', frente: 'Racionalidad limitada (Simon)', reverso: 'El decisor opera con limitaciones cognitivas y de información, no con certeza total.', tema: 's10-analisis-descriptivo' },
    { id: 's10f4', frente: 'Pensamiento intuitivo vs reflexivo', reverso: 'Intuitivo: automático y rápido. Reflexivo: lento, consciente y analítico.', tema: 's10-analisis-descriptivo' },
